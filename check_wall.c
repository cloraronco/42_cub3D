...
/*   Updated: 2023/01/03 13:03:10 by clora-ro         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int	check_up(t_map *map)
{
	...
	Ry = (((map->pix_y - map->pdy) - (size_mini)) / size_mini);
	if (map->pdx > 0 && map->pdy > 0
		&& map->map[x + Rx][y] != '1' && map->map[x][y + Ry] != '1')
		return (1);
	else if (map->pdx <= 0 && map->pdy <= 0
		&& map->map[x + Rx + 1][y] != '1' && map->map[x][y + Ry + 1] != '1')
		return (1);
	else if (map->pdx > 0 && map->pdy <= 0
		&& map->map[x + Rx][y] != '1' && map->map[x][y + Ry + 1] != '1')
		return (1);
	else if (map->pdx <= 0 && map->pdy > 0
		&& map->map[x + Rx + 1][y] != '1' && map->map[x][y + Ry] != '1')
		return (1);
	...
	// 	return (1);
	// }
	// if (map->pdy <= 0 && map->map[x][y + Ry + 1] != '1')
	// {
	// 	// droite
	// 	return (1);
	// }
	// if (map->pdy > 0 && map->map[x][y + Ry] != '1')
	// {
	// 	// gauche
	// 	return (1);
	// }
